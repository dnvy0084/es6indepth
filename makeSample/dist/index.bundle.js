...
var values = (0, _symbol2.default)('values');
...
var Point = function () {
	...
	(0, _createClass3.default)(Point, [{
		...
		value: function value() {
			return (0, _getIterator3.default)(this[values]);
		}
	}, {
		key: 'entries',
			...
			return _regenerator2.default.wrap(function entries$(_context) {
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							return _context.delegateYield([['x', this.x], ['y', this.y]], 't0', 1);
...
var _marked = [range, fibo].map(_regenerator2.default.mark);
...
function fibo(len) {
	...
	return _regenerator2.default.wrap(function fibo$(_context2) {
		while (1) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(95), __webpack_require__(93)))
...
var _toArray2 = __webpack_require__(52);
...
var _iterator3 = __webpack_require__(32);
...
var _console2; // require( 'babel-polyfill' );
...
var p = new _Point2.default(3, 4);

var _p$entries = p.entries(),
    _p$entries2 = (0, _toArray3.default)(_p$entries),
    values = _p$entries2.slice(0);

console.log(values);

p.scale(2);

(_console2 = console).log.apply(_console2, (0, _toConsumableArray3.default)(p));
...
try {
	for (var _iterator = (0, _getIterator3.default)((0, _range.fibo)(10)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		var n = _step.value;
		console.log('fibo ' + n);
	}
} catch (err) {
...
try {
	for (var _iterator2 = (0, _getIterator3.default)((0, _range.range)(10, 20)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
		var _n = _step2.value;
		console.log('range ' + _n);
	}
} catch (err) {
...
window.range = _range.range;
window.fibo = _range.fibo;
